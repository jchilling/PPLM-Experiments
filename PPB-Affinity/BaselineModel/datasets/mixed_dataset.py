...
class MixedDataset(Dataset):
    ...
    def __init__(
        ...
        self.five_fold_pdb_path = five_fold_pdb_path
        ...
        # print("self.entries_full:", len(self.entries_full), self.entries_full)

        self.structures_cache = os.path.join(cache_dir, 'structures.pkl')
        self.structures = None
        self._load_structures(reset)

        print("MixedDataset:", self.cvfold_index, self.num_cvfolds, len(self.entries), len(self.entries_full), len(self.structures))
    ...
    def _load_entries(self, reset):
        ...
        if self.strict:
            ...
            # ### Original PPB-Affinity split folds ###
            ...
            ### JUNL split folds ###
            if self.split == 'val':
                # five_fold_pdb_path = "/mnt/rna01/junl/tools/PPB-Affinity-main/pdb_chains_structs.cov_60_id_60.valid_pdb.pkl"
                with open(self.five_fold_pdb_path, 'rb') as f:
                    five_fold_pdbs = pickle.load(f)
                complexes_this = five_fold_pdbs[self.cvfold_index]
            else:
                # five_fold_pdb_path = "/mnt/rna01/junl/tools/PPB-Affinity-main/pdb_chains_structs.cov_60_id_60.train_pdb.pkl"
                with open(self.five_fold_pdb_path, 'rb') as f:
                    five_fold_pdbs = pickle.load(f)
                complexes_this = five_fold_pdbs[self.cvfold_index]
            ###====================================###
            ...
            print("complex_splits:", len(complexes_this), complexes_this[:5])
            entries = []
        ...
        # print("self.entries:", len(self.entries), self.entries[:10])
