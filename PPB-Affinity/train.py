...
if __name__ == '__main__':
    ...
    parser.add_argument('five_fold_train_pdb_path', type=str)
    parser.add_argument('five_fold_valid_pdb_path', type=str)
    parser.add_argument('--seed_round', type=int, default=0)
    ...
    seeds = [26240761, 73591024, 48136297, 95317406, 62780953, 58302741, 94716038, 12649570, 80421359, 39287564]
    seed = seeds[args.seed_round]# + args.seed_add
    seed_all(seed)
    ...
    # Data
    print("   five_fold_train_pdb_path:", args.five_fold_train_pdb_path)
    print("   five_valid_train_pdb_path:", args.five_fold_train_pdb_path)
    logger.info('   five_fold_train_pdb_path: %s' % args.five_fold_train_pdb_path)
    logger.info("   five_valid_train_pdb_path: %s" % args.five_fold_train_pdb_path)

    dataset_mgr = MixedDatasetManager(
        config, 
        num_cvfolds=num_cvfolds, 
        num_workers=args.num_workers,
        five_fold_train_pdb_path=args.five_fold_train_pdb_path,
        five_fold_valid_pdb_path=args.five_fold_valid_pdb_path,
        logger=logger,
    )
    ...
    # with open(os.path.join('/mnt/rna01/junl/PPLM/PPLM/pplm_affinity/data/pdb_chains_structs.cov_60_id_60.train_pdb.pkl'), 'wb') as f:
    #     pickle.dump(dataset_mgr.train_split, f)
    # with open(os.path.join('/mnt/rna01/junl/PPLM/PPLM/pplm_affinity/data/pdb_chains_structs.cov_60_id_60.valid_pdb.pkl'), 'wb') as f:
    #     pickle.dump(dataset_mgr.val_split, f)
